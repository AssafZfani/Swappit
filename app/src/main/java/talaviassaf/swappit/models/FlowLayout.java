...
public class FlowLayout extends ViewGroup {
    ...
    private final LayoutProcessor layoutProcessor = new LayoutProcessor();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int childHeightMeasureSpec = MeasureSpec.getMode(heightMeasureSpec) == MeasureSpec.AT_MOST ?
                MeasureSpec.makeMeasureSpec(height, MeasureSpec.AT_MOST) : MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE) {
                ...
                lineHeight = Math.max(lineHeight, child.getMeasuredHeight() + 25);
    ...
    private class LayoutProcessor {
        ...
        void layoutPreviousRow() {
            ...
            int minimumHorizontalSpacing = 30;

            switch (Gravity.START) {
